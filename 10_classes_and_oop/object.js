...
function. This means that it has access to 
properties  and methods defined on the constructor's
prototype.
...
, javascript assumes this, the newly created object, to be the
intended return value ..


the new object is returned: after the constructor function has 
been called  , if it doesn't return a non- primittive value (object,
array, function, etc.), the newly created object
is returned.
